...
- **Docs** — `docs/managed-agents/` local reference, verified against live docs 2026-08-29. Sprint notes in `docs/sprints/`; `docs/app/going-public.md` is the checklist for flipping the repo public. **Start at `docs/app/README.md`** (index) and `docs/app/runbook.md` (operations).
